...
void SandMachine::moveStepper0ToDeg(float degrees) {
  ...
  float new_deg = degrees + _stepper0_offset;
  _stepper0->moveTo(new_deg * _stepper_deg_ratio);
  _stepper0_last_deg = degrees;
}
...
void SandMachine::moveStepper1ToDeg(float degrees) {
  ...
  float new_deg = degrees + _stepper1_offset;
  _stepper1->moveTo(new_deg * _stepper_deg_ratio);
  _stepper1_last_deg = degrees;
}
